...
(function() {
    ...
    function process() {
        ...
        var compareImg = '<li><a id="octo-compare" class="js-selected-navigation-item reponav-item" href="' + hrefStr + '">' +
            ...
            '0 0 0 12 15a1.993 1.993 0 0 0 1-3.72zm-1 2.92c-.66 0-1.2-.55-1.2-1.2 0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2z"></path></svg>      Compare</a></li>';
        console.log("Injecting Compare Link");
        if (!iBefore) $(iInto).after(compareImg);
        else $(iInto).before(compareImg);
        checkIfCompareStillExists();
        $('.container-lg').css('max-width', '1040px');
